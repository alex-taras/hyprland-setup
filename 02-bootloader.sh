...
/Arch Linux (linux-cachyos)
    ...
    cmdline: root=PARTUUID=$PARTUUID zswap.enabled=0 ${ROOTFLAGS}rw rootfstype=$FSTYPE quiet loglevel=3 rd.udev.log_level=3 vt.global_cursor_default=0 console=tty2 plymouth.ignore-serial-consoles amdgpu.ppfeaturemask=0xffffffff
